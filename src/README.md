...
| File | Purpose |
|------|---------|
| `build_crosswalk.py` | **Main entry point.** Unified pipeline that matches plant names from all 7 generation sources to coordinates. Run with `python -m src.build_crosswalk`. |
